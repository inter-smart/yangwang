...
const CustomPopup = ({ branch }) => {
    return (
        <div className="popup-content w-64 group">
            ...
            <h3 className="font-bold text-[20px] text-white mb-[20px] pb-[15px] relative after:content-[''] after:absolute after:bottom-0 after:left-[-1px] after:w-[350px] after:h-[5px] after:bg-[#5949A7]">  {branch.name}</h3>

            <div className="flex items-start mb-[15px] flex-wrap">

                <span className="w-[calc(100%-16px)] text-[16px] font-normal text-white  m-0">{branch.address}</span>
            </div>
...
export default function LocationMap() {
    ...
    return (
        <div className="flex w-full h-[510px] 2xl:h-[670px] relative z-[1] overflow-hidden">


            <div className="w-[430px] lg:w-[320px)] xl:w-[360px)] 2xl:w-[585px] pr-[40px] text-white">

                <div className="realtive overflow-y-auto max-h-[calc(100%-65px)]">
                    {branchLocations.map((branch) => (
                        <div
                            key={branch.id}
                        ...
                        >
                            ...
                            >
                                <div className="px-[5px]">
                                    <a
                                        ...
                                        target="_blank"
                                        className="w-[33px] h-[33px] rounded-full bg-[#6958B9] flex items-center justify-center"
                                    >
                                        <div className="w-[15px] h-[15px] flex">
                                            <svg viewBox="0 0 15 15"  >
                                                <g clip-path="url(#clip0_519_2721)">
                            ...
                            <div className='w-full max-w-[380px] flex items-start'>
                                ...
                                <div className='w-[calc(100% - 30px)] px-[15px]'>
                                    <Heading
                                        size="heading6"
                                        as="h6"
            ...
            <div className="w-[calc(100%-430px)] lg:w-[calc(100%-320px)] xl:w-[calc(100%-360px)] 2xl:w-[calc(100%-585px)] relative">
                <MapContainer
                    center={mapCenter}
                    zoom={12}
