...
export default function OwnershipSection({ title, description }) {
    return (
        <section className="w-full min-h-[355px] xl:min-h-[495px] 2xl:min-h-[700px] 3xl:min-h-800px] flex items-end py-[70px_15px] lg:py-[80px_35px] xl:py-[90px_45px] 3xl:py-[120px_75px] relative z-0 before:content-[''] before:block before:absolute before:-z-1 before:left-0 before:inset-0 before:w-full before:h-full before:bg-gradient-to-t before:from-black/60 before:to-black/60 before:pointer-events-none after:content-[''] after:block after:absolute after:-z-1 after:left-0 after:inset-0 after:w-1/2 after:h-full after:bg-gradient-to-r after:from-black after:to-black/0 after:pointer-events-none">
            <video
