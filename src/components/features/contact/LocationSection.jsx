              ...
              <div className="w-full sm:w-1/2 lg:w-auto p-[8px]">
                <div className="flex items-start">
                  ...
                  <div className="ltr:pl-[15px] rtl:pr-[15px] w-[calc(100%-33px)]">
                    ...
                    <a
                      href="tel:008968 24578000"
                      className="3xl:text-[20px] 2xl:text-[17px] xl:text-[13px] lg:text-[12px] text-[12px] transition-all text-white hover:text-[#5949A7] "
                    >
                      008968 24578000
                    </a>
                  </div>
              ...
              <div className="w-full sm:w-1/2 lg:w-auto p-[8px]">
                <div className="flex items-start">
                    ...
                    <div className="w-[15px] h-[15px] flex items-center justify-center">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_538_6967)">
                          ...
                          />
                          <path
                            d="M0.168258 3.55811C0.0639844 3.76897 0 4.00304 0 4.25378V13.746C0 13.9967 0.0639141 14.2308 0.168223 14.4416L5.59223 9.00005L0.168258 3.55811Z"
                            fill="white"
                          />
                          <path
                            d="M17.8321 3.55811L12.4082 9.00012L17.8321 14.4418C17.9364 14.2309 18.0004 13.9968 18.0004 13.746V4.25385C18.0004 4.00304 17.9364 3.76897 17.8321 3.55811Z"
                            fill="white"
                          />
                        </g>
                        <defs>
                  ...
                  <div className="ltr:pl-[15px] rtl:pr-[15px]  w-[calc(100%-33px)]">
                    ...
                    <a
                      href="mailto:Support@Yangwang.com"
                      className="3xl:text-[20px] 2xl:text-[17px] xl:text-[13px] lg:text-[12px] text-[12px] transition-all text-white hover:text-[#5949A7]"
                    >
