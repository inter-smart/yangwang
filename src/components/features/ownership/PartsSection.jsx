  ...
  return (
    <section className="w-full h-auto block relative z-0">
      <div className="container">
        ...
        > */}
          <div className="w-full md:w-1/2 3xl:py-[115px_120px] xl:py-[100px_90px] lg:py-[80px_70px] md:py-[65px_50px] py-[30px_35px]">
            <div className="h-full flex flex-wrap items-center 2xl:px-[50px] xl:px-[20px] md:px-[15px]">
              <div className="h-fit w-full">
                ...
                <div className="w-full flex flex-wrap gap-[15px] xl:gap-[20px] 2xl:gap-[30px] 3xl:gap-[40px] -m-[5px] 2xl:mt-[60px] mt-[30px]">
