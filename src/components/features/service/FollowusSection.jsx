          ...
          {data?.social_media_links?.map(
            ({ icon, icon_alt, name, url }, idx) => (
              <a
                ...
                className=" 2xl:w-[50px] xl:w-[40px] sm:w-[40px] w-[35px] aspect-square rounded-full flex items-center justify-center border border-gray-300 text-black transition-all duration-300 hover:bg-[#5949A7] hover:text-white cursor-pointer"
              >
                <Image
                  src={icon}
                  ...
                  width={16}
                  height={16}
                  className="w-[10px] xl:w-[14px] aspect-square object-contain"
                />
              </a>
            )
          )}
