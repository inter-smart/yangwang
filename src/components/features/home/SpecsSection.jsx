...
const specsInfo = [
  {
    ...
    description:
      "Advanced Design. Revolutionary Technology. Uncompromised Power.",
                  ...
                  {specsInfo?.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center gap-[10px] sm:gap-[15px] xl:gap-[20px] 3xl:gap-[30px]">
                        ...
                        />
                        <div className="flex-1">
                          <h6 className="text-[10px] sm:text-[12px] lg:text-[12px] xl:text-[13px] 2xl:text-[17px] 3xl:text-[20px] font-medium leading-tight capitalize text-black xl:max-w-[60px] 3xl:max-w-[100px]">
                            {item.title}
                          </h6>
                        </div>
                      </div>
