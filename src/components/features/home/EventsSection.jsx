    ...
    <section className="w-full h-auto block bg-[#f6f6f6] py-[30px] sm:py-[40px_30px] lg:py-[60px_40px] xl:py-[80px_60px] 3xl:py-[120px_80px]">
      <div className="container">
        <div className="flex flex-wrap lg:-mx-[10px] xl:-mx-[15px] 3xl:-mx-[25px] max-lg:[&>*]:py-[10px] lg:[&>*]:px-[10px] xl:[&>*]:px-[15px] 3xl:[&>*]:px-[25px]">
          <div className="w-full lg:w-[280px] xl:w-[300px] 2xl:w-[340px] 3xl:w-[440px]">
            <Heading
              size="heading3"
              as="h3"
          ...
          <div className="w-full lg:w-[calc(100%-280px)] xl:w-[calc(100%-300px)] 2xl:w-[calc(100%-340px)] 3xl:w-[calc(100%-440px)]">
              ...
              {slide?.map((item, index) => (
                ...
                >
                  <Card className="w-full h-auto block rounded-none border-0 shadow-none p-0 overflow-hidden relative z-0">
                    <CardContent
                      className={`${
                        index === 0 ? "h-[220px] sm:h-[320px] lg:h-[400px] xl:h-[490px] 2xl:h-[560px] 3xl:h-[740px]" : "h-[86px] sm:h-[220px] lg:h-[168px] xl:h-[202px] 2xl:h-[233px] 3xl:h-[311px]"
