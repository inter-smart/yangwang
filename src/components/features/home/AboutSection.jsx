...
function cleanHtmlText(html) {
  ...
  // Get text content (automatically handles entities)
...
export default function AboutSection({ data }) {
  ...
  const desc = cleanHtmlText(data?.description) || "";
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full h-auto flex justify-between relative z-0 -mt-[20px] xl:-mt-[40px] 3xl:-mt-[60px] pointer-events-none"
        dir="ltr"
      >
        <Img
          src="about-bg-1.png"
