...
const accordionData = [
  {
    media: {
      type: "image",
      web_banner: {
        url: "/images/u8-performance-bg.jpg",
        thumbnail: "/images/u8-performance-bg.jpg",
        alt_text: "thumbnail image",
      },
      mobile_banner: {
        url: "/images/mob-u8-performance-bg.jpg",
        thumbnail: "/images/mob-u8-performance-bg.jpg",
        alt_text: "thumbnail image",
      },
    },
  ...
  },
  {
    media: {
      type: "image",
      web_banner: {
        url: "/images/poster-interior-1.jpg",
...
export default function PerformanceSection() {
  ...
  const activeItem = accordionData[activeIndex];
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {activeItem.media.type === "video" ? (
            ...
            >
              <source src={activeItem.media.web_banner.url} type="video/mp4" />
