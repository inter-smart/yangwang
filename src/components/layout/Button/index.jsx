...
const sizes = {
  button1:
    "3xl:text-[14px] 2xl:text-[12px] xl:text-[9px] lg:text-[9px] text-[9px] font-medium leading-none text-center whitespace-nowrap w-full h-[30px] sm:h-[30px] lg:h-[33px] 2xl:h-[43px] 3xl:h-[50px] flex flex-row items-center justify-center gap-[5px] lg:gap-[10px] 3xl:gap-[14px] p-[5px] cursor-pointer rounded-none border border-solid",
};
